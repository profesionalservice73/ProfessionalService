...
const experienceLevels = [
  { id: 'beginner', name: 'Principiante (0-2 años)', icon: 'star-outline' },
  { id: 'intermediate', name: 'Intermedio (3-5 años)', icon: 'star-half' },
  { id: 'advanced', name: 'Avanzado (6-10 años)', icon: 'star' },
  { id: 'expert', name: 'Experto (10+ años)', icon: 'diamond' },
];

export default function ProfessionalRegisterStepsScreen({ navigation }: any) {
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 2) {
      ...
      if (!dniFrontImage) newErrors.dniFrontImage = 'La foto frontal del DNI es requerida';
      if (!dniBackImage) newErrors.dniBackImage = 'La foto trasera del DNI es requerida';
    }
            ...
            [
              {
                text: 'OK',
                onPress: () => {
                  // El RegistrationGuard manejará la navegación
                },
              },
            ]
          );
  ...
  const renderStep2 = () => (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.inputContainer}>
        ...
        {errors.dniFrontImage && <Text style={styles.errorText}>{errors.dniFrontImage}</Text>}
        
        {dniFrontImage ? (
          <View style={styles.imageContainer}>
            <Image source={{ uri: dniFrontImage }} style={styles.dniImage} />
            <TouchableOpacity style={styles.removeImageButton} onPress={() => setDniFrontImage(null)}>
              <Ionicons name="close-circle" size={24} color={theme.colors.error} />
            </TouchableOpacity>
          </View>
        ) : (
          <View style={styles.imageSelectorContainer}>
            <TouchableOpacity style={styles.imageSelector} onPress={() => takePhoto('dni_front')}>
              <Ionicons name="camera" size={32} color={theme.colors.primary} />
              <Text style={styles.imageSelectorText}>Tomar Foto</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.imageSelector} onPress={() => selectImage('dni_front')}>
              <Ionicons name="images" size={32} color={theme.colors.primary} />
              <Text style={styles.imageSelectorText}>Galería</Text>
            </TouchableOpacity>
          </View>
      ...
      <View style={styles.inputContainer}>
        ...
        <Text style={styles.inputSubtext}>Necesitamos verificar tu identidad</Text>
        {errors.dniBackImage && <Text style={styles.errorText}>{errors.dniBackImage}</Text>}
        
        {dniBackImage ? (
          <View style={styles.imageContainer}>
            <Image source={{ uri: dniBackImage }} style={styles.dniImage} />
            <TouchableOpacity style={styles.removeImageButton} onPress={() => setDniBackImage(null)}>
              <Ionicons name="close-circle" size={24} color={theme.colors.error} />
            </TouchableOpacity>
          </View>
        ) : (
          <View style={styles.imageSelectorContainer}>
            <TouchableOpacity style={styles.imageSelector} onPress={() => takePhoto('dni_back')}>
              <Ionicons name="camera" size={32} color={theme.colors.primary} />
              <Text style={styles.imageSelectorText}>Tomar Foto</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.imageSelector} onPress={() => selectImage('dni_back')}>
              <Ionicons name="images" size={32} color={theme.colors.primary} />
              <Text style={styles.imageSelectorText}>Galería</Text>
            </TouchableOpacity>
          </View>
        ...
        {experienceLevels.map((level) => (
          ...
          >
            <Ionicons 
              ...
              size={24} 
              color={formData.experience === level.id ? theme.colors.white : theme.colors.primary} 
            />
            <Text style={[
  ...
  const renderStep3 = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        ...
        <Text style={styles.stepSubtitle}>Define qué ofreces y a qué precio</Text>
      </View>
  ...
  const renderStep4 = () => (
    <View style={styles.stepContainer}>
      <View style={styles.stepHeader}>
        ...
        <Text style={styles.stepSubtitle}>Completa tu perfil profesional</Text>
      </View>
